...
function unionDelaNavbar(){
    let navbarCompleta = [
        ...
        <nav class="carrito-and-login all-width">
            ...
            ${menuArray2} ${localStorage.getItem("usuario") ? `<li class="carrito-and-login-link" style="color: #fff;">Hola ${localStorage.getItem("usuario")}</li>` : `<li class="carrito-and-login-item"><a href="pages/loging.html" class="carrito-and-login-link">Ingresar</a></li>`}
            </ul>
        </nav>
        `
    ]
